...
//---------------------------------------------------------------------------------
s32 _readTouchValue(int measure, int retry , int range) {
//---------------------------------------------------------------------------------
	int i;
...
//---------------------------------------------------------------------------------
	...
	touchPos.x = _readTouchValue(TSC_MEASURE_X, _MaxRetry, _MaxRange);
	touchPos.y = _readTouchValue(TSC_MEASURE_Y, _MaxRetry, _MaxRange);
