...
// ?¤ì œë¡?MIDI Event?ì„œ statueë¥?ê¸°ì??¼ë¡œ ?°ì´?°ë? ì²˜ë¦¬?˜ëŠ” ë¶€ë¶„ì„ êµ¬í˜„???¨ìˆ˜?´ë‹¤. 
// ???¨ìˆ˜?ì„œ Smidlib_mrtk.* ???•ì˜???¨ìˆ˜ë¥??¸ì¶œ?˜ì—¬ ë¯¸ë”” ë©”ì‹œì§€ë¥?ì²˜ë¦¬?œë‹¤. 
static void SM_ProcMIDIEvent(bool ShowMessage,bool EnableNote,TSM_Track *pSM_Track,u32 Status)
{
  TStdMIDI *_StdMIDI=&StdMIDI;

  /*
  ?´ë ‡ê²?cmdë¥??µí•´??ë©”ì‹œì§€??ì¢…ë¥˜ë¥?êµ¬ë¶„?˜ëŠ” ê¸°ì??€ ?¤ìŒ???˜ì´ì§€ë¥?ì°¸ì¡°?˜ìž.
  ...
  */
  ...
  /*
  ë©”ì‹œì§€ ì¢…ë¥˜???°ë¼ ?œë°”?´íŠ¸ë§??¬ìš©?˜ëŠ”ì§€, ?ë°”?´íŠ¸ë§??¬ìš©???˜ëŠ”ì§€ ê²°ì •?œë‹¤. 
  ?¬ê¸°??ë¬¸ì‰˜ ?œìž‘?ëŠ” ì½”ë“œ?´ì—??ê°„ë‹¨??ë§¤í¬ë¡œë? ?•ì˜?˜ì—¬ ?˜ë¦„ ê¹”ë”?˜ê²Œ ?•ë¦¬?´ë³´?¤ê³  ?¸ë ¥?œê²ƒ ê°™ë‹¤.

  ?ˆë? ?¤ì–´ Note On??ê²½ìš° ?¤ìŒê³?ê°™ì´ ?¬ìš©?œë‹¤
