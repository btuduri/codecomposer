  ...
  .global TTAC_Decode_6bit_asm
TTAC_Decode_6bit_asm:

// for 6bit
#define Stage2_BitShift (4)
#define HybridFilter_Shift (10)
#define HybridFilter_MUL smulbb
#define HybridFilter_MLA smlabb
#define ConvertSample(reg_src,reg_dst) lsl reg_dst,reg_src,#2
#define StoreSampleBuffer(reg_src,reg_dst) strb reg_src,[reg_dst],#1
